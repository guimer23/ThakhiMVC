...
! function($) {
    ...
    FlotChart.prototype.createPlotGraph = function(selector, data1, data2, labels, colors, borderColor, bgColor) {
        ...
        FlotChart.prototype.init = function() {
            ...
            var datas = [20, 30, 15];
            var colors = ['#1a2035', '#4ac7ec', "#f3c74d"];
            this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);


            //real time data representation
            var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#1a2035']);
            plot.draw();
            var $this = this;
            ...
            var donutcolors = ['#1a2035', '#ff5da0', "#f0f1f4"];
