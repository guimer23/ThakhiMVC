                    ...
                    <div class="card auth-card shadow">
                        <div class="card-body">
                            <div class="px-3">
                                ...
                                <form  action="?c=login&a=logear"  method="post" id="formulariologin" class="form-horizontal auth-form my-4" >
                                    ...
                                    <div class="form-group mb-0 row">
                                        <div class="col-12 mt-2">
                                            <button  type="submit" id="entrarsistema" class="btn btn-dark btn-round btn-block waves-effect waves-light" >Ingresar <i class="fas fa-sign-in-alt ml-1"></i></button>
                                        </div><!--end col-->
                                    </div> <!--end form-group-->
                                </form><!--end form-->
                            </div><!--end /div-->
