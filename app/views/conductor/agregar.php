<div class="page-wrapper">
   ...
   <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <div class="card">
                                <form  method="post" action="?c=conductor&a=guardar"  id="frmconductor"  enctype="multipart/form-data">
                                  <div class="row">
                                              ...
                                              <div class="row clearfix">
                                                  ...
                                                  <div class="col-md-4">
                                                      <div class="form-group">
                                                          ...
                                                          <input type="date" id="CONvigencialicencia" name="CONvigencialicencia" class="form-control"  value="<?php echo $nuevo ? '' : $model->CONvigencialicencia; ?>" >
                                                      </div>
                                                  </div>
                                                  <div class="col-md-4">
                                                      <div class="form-group">
                                                          <label>Celular </label>
                                                          <input type="text" id="CONcelular" name="CONcelular" class="form-control"   value="<?php echo $nuevo ? '' : $model->CONcelular; ?>"  maxlength="9" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" min="1" pattern="^[0-9]+" onpaste="return false;" onDrop="return false;" autocomplete=off required/>
                                                      </div>
                                                  </div>
                                              </div>
                                              <div class="row clearfix">
                                                ...
                                                <div class="row clearfix">
                                                  <div class="col-md-8">
                                                      <div class="form-group">
                                                          ...
                                                          <input type="text" id="CONdireccion" name="CONdireccion"  class="form-control" value="<?php echo $nuevo ? '' : $model->CONdireccion; ?>"  >
                                                      </div>
                                                  </div>
                                                  <div class="col-md-4">
                                                      <label>Estado</label>
